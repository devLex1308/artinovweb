...
<div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6 create-transport content">
            <form class="form-horizontal" role="form" method="post">
                <div class="form-group">
                    <label for="name" class="col-lg-12 control-label">Назва транспорту</label>
                    <div class="col-sm-12">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Ввести назву" value="<?php echo $transport['name'];?>" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="description" class="col-lg-12 control-label">Опис транспорту</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label for="carriage_id" class="col-lg-12 control-label">Вид транспорту</label>
                    <div class="col-sm-12">
                ...
                <div class="form-group">
                    <label for="route_id" class="col-lg-12 control-label">id маршруту</label>
                    <div class="col-sm-12">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 create-transport content">
            <div class="row">
