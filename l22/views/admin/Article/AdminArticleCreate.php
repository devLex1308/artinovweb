  ...
  <div class="row">
    ...
    <div class="col-md-12 col-lg-10 create-station">
      <form class="form-horizontal" role="form" method="post">
            ...
            <select class="form-control" name="category_id" required>
              ...
              if(!empty($categories)){
                foreach ($categories as $key => $category) {
                  echo "<option "; echo "selected"; echo " value=".$category['id'].">".$category['name']."</option>";
                }
              }
              ?>
            </select>
        ...
        <button class="btn btn-primary" href="#" type="submit" name="createArticle" role="submit" class="control-labell">Створити</button>
      </form>
    </div>
    <div class="col-lg-1"></div>
  </div>
