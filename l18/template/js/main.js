...
if(!el1.checked && !el2.checked && !el3.checked){
	el.src="template/images/tram-1.png";
	el1.checked="checked";
	$(t1).css({"color":"#fbb03b"});
}
function tram(id){
	...
	switch(id){
		case 'tram-id': {
			el1.src="template/images/tram-1.png";
			el2.src="template/images/trolleybus.png";
			el3.src="template/images/bus.png";
		...
		case 'trolleybus-id': {
			el1.src="template/images/tram.png";
			el2.src="template/images/trolleybus-1.png";
			el3.src="template/images/bus.png";
		...
		case 'bus-id': {
			el1.src="template/images/tram.png";
			el2.src="template/images/trolleybus.png";
			el3.src="template/images/bus-1.png";
