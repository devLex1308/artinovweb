        ...
        <div class="col-xs-10 col-sm-10 col-md-8 col-lg-6 create-station">
            ...
            <form class="form-horizontal" role="form" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="2" id="description" name="description" placeholder="Короткий опис зупинки при необхідності..."></textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" rows="2" id="neighboring_stop" name="neighboring_stop" placeholder="Перелік зупинок"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="map_x" class="col-sm-3 control-label">Координата Х на карті-схемі</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="map_x" name="map_x" placeholder="Координата Х" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="map_y" class="col-sm-3 control-label">Координата Y на карті-схемі</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="map_y" name="map_y" placeholder="Координата Y" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="latitude" class="col-sm-3 control-label">Широта</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="latitude" name="latitude" placeholder="49° 13'" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="longitude" class="col-sm-3 control-label">Довгота</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="longitude" name="longitude" placeholder="28° 28'" required>
                    </div>
                </div>
                <input type="hidden" name="typeform" value="createStation">
                <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-9">
                        <input name="createStation" type="submit" class="btn btn-warning">
                    </div>
                </div>
            </form>
        </div>
